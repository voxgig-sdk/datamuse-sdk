...
type Args struct {
	Entity string         `json:"entity" jsonschema:"pet"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.DatamuseSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "datamuse_list",
		Description: "List records from Datamuse. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "datamuse_load",
		Description: "Load a single record from Datamuse. " +
...
func runOp(client *sdk.DatamuseSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.DatamuseSDK, name string) (sdk.DatamuseEntity, error) {
