# Datamuse Python SDK Reference

Complete API reference for the Datamuse Python SDK.
...
#### `DatamuseSDK.test(testopts=None, sdkopts=None)`
...
```python
result, err = client.Pet().remove({"id": "pet_id"})
```
