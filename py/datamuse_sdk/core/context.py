...
from datamuse_sdk.core.helpers import get_ctx_prop, to_map
...
class DatamuseContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, DatamuseResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, DatamuseResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return DatamuseError(code, msg, self)
