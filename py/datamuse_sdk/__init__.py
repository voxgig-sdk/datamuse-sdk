...
from datamuse_sdk.utility import register

# Load features
from datamuse_sdk.feature.base_feature import DatamuseBaseFeature
from datamuse_sdk.features import _has_feature, _make_feature
...
class DatamuseSDK:
    ...
    def get_utility(self):
        return DatamuseUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("DatamuseSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Pet(self, data=None) -> "PetEntity":
        ...
        from datamuse_sdk.entity.pet_entity import PetEntity
