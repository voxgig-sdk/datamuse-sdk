# Datamuse SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DatamuseSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DatamuseSDK(...) and DatamuseSDK.test(...) become
#      DatamuseSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "datamuse_sdk"
_SDK_CLASS = "DatamuseSDK"
