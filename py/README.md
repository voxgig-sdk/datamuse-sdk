...
The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Pet()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/datamuse-sdk/releases)) or
...
```
py/
├── datamuse_sdk.py         -- Main SDK module
