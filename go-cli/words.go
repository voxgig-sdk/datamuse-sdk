...
func registerSDKWords(r *eng.Registry, client *sdk.DatamuseSDK) {
...
func runOp(client *sdk.DatamuseSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
