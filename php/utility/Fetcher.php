...
// Datamuse SDK utility: fetcher

class DatamuseFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DatamuseSDK/1.0)';
    ...
    public static function call(DatamuseContext $ctx, string $fullurl, array $fetchdef): array
    {
