...
class DatamuseTimeoutFeature extends DatamuseBaseFeature
{
    ...
    private function _with_timeout(DatamuseContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DatamuseContext $_ctx, float $ms): void
    {
        $client = $this->client;
