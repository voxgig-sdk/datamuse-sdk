...
// Datamuse SDK streaming feature
...
class DatamuseStreamingFeature extends DatamuseBaseFeature
{
    ...
    private function _iterate(DatamuseResult $result): \Generator
    {
    ...
    private function _streamable(DatamuseContext $ctx): bool
    {
