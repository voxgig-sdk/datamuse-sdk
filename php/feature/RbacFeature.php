...
class DatamuseRbacFeature extends DatamuseBaseFeature
{
    ...
    private function _required(DatamuseContext $ctx): ?string
    {
    ...
    private function _reject(DatamuseContext $ctx, string $required): void
    {
    ...
    private function _track(DatamuseContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
