...
// Datamuse SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = DatamuseOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(DatamuseOmni::structfix($now, Struct::undef()))
                        !== json_encode(DatamuseOmni::structfix($val, Struct::undef()))) {
