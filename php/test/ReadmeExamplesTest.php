...
// Datamuse SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DatamuseSDK::test)
...
{
    private const SDK_CLASS = 'DatamuseSDK';
    ...
    private const SDK_BASE = 'datamuse_sdk';
