...
class DatamuseTestRunner
{
    ...
    {
        $live = self::getenv('DATAMUSE_TEST_LIVE');
        $override = self::getenv('DATAMUSE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('DATAMUSE_TEST_EXPLAIN');
...
class_alias('DatamuseTestRunner', 'Runner');
class_alias('DatamuseHelpers', 'Helpers');
