...
module DatamuseTestRunner
  ...
  def self.env_override(m)
    live = getenv("DATAMUSE_TEST_LIVE")
    override = getenv("DATAMUSE_TEST_OVERRIDE")
    ...
    explain = getenv("DATAMUSE_TEST_EXPLAIN")
    m["DATAMUSE_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = DatamuseTestRunner
Helpers = DatamuseHelpers
Vs = VoxgigStruct
