...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/datamuse` | `npm install @voxgig-sdk/datamuse` |
| Python | `voxgig-sdk-datamuse` | `pip install voxgig-sdk-datamuse` |
| PHP | `voxgig-sdk/datamuse` | `composer require voxgig-sdk/datamuse` |
| Golang | `github.com/voxgig-sdk/datamuse-sdk/go` | `go get github.com/voxgig-sdk/datamuse-sdk/go` |
| Ruby | `voxgig-sdk-datamuse` | `gem install voxgig-sdk-datamuse` |
| Lua | `voxgig-sdk-datamuse` | `luarocks install voxgig-sdk-datamuse` |
