...
local DatamuseSDK = {}
DatamuseSDK.__index = DatamuseSDK
...
DatamuseSDK._make_feature = _make_feature


function DatamuseSDK.new(options)
  local self = setmetatable({}, DatamuseSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function DatamuseSDK:options_map()
...
function DatamuseSDK:get_utility()
  return Utility.copy(self._utility)
end


function DatamuseSDK:get_root_ctx()
  return self._rootctx
end


function DatamuseSDK:prepare(fetchargs)
...
function DatamuseSDK:direct(fetchargs)
...
-- by passing it.
function DatamuseSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function DatamuseSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "DatamuseSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function DatamuseSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = DatamuseSDK.new(sdkopts)
  sdk.mode = "test"
