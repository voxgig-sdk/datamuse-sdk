...
`client.Pet()` — each with a small set of operations (`list`, `load`, `create`, `remove`)
...
| `tester(testopts?, sdkopts?)` | `DatamuseSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `DatamuseSDK.test(testopts?, sdkopts?)` | `DatamuseSDK` | Create a test-mode client. |
