...
function envOverride(m) {
    if ('TRUE' === process.env.DATAMUSE_TEST_LIVE ||
        'TRUE' === process.env.DATAMUSE_TEST_OVERRIDE) {
    ...
    m.DATAMUSE_TEST_EXPLAIN = process.env.DATAMUSE_TEST_EXPLAIN || m.DATAMUSE_TEST_EXPLAIN;
    return m;
}
