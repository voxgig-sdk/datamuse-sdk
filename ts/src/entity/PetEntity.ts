...
class PetEntity extends DatamuseEntityBase<Pet> {
  ...
  make(this: PetEntity) {
    return new PetEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: PetLoadMatch, ctrl?: Control): Promise<PetEntity> {
  ...
  async list(this: any, reqmatch?: PetListMatch, ctrl?: Control): Promise<PetEntity[]> {
  ...
  async create(this: any, reqdata?: PetCreateData, ctrl?: Control): Promise<PetEntity> {
  ...
  async remove(
    this: any, reqmatch?: PetRemoveMatch, ctrl?: Control,
  ): Promise<PetEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<PetEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
