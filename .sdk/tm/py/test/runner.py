...
class DatamuseTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DatamuseTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = DatamuseTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = DatamuseTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
