...
class DatamuseTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DatamuseTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = DatamuseTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = DatamuseTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
