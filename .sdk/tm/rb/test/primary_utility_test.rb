...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = DatamuseOmni.make_runner(TEST_JSON_FILE, DatamuseSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : DatamuseOmni.errify(err)
    end
