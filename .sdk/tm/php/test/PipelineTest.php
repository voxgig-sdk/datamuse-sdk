...
{
    private static function utility(): DatamuseUtility
    {
        return new DatamuseUtility();
    }
    ...
    private static function ctx(array $over = []): DatamuseContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new DatamuseContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new DatamuseOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof DatamuseError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new DatamuseOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = DatamuseMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new DatamuseOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = DatamuseMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new DatamuseOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = DatamuseMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new DatamuseSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = DatamuseMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new DatamuseResponse([]),
            'result' => new DatamuseResult([]),
        ]);
        [, $err] = DatamuseMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new DatamuseSpec([]),
            'response' => null,
            'result' => new DatamuseResult([]),
        ]);
        [, $err] = DatamuseMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new DatamuseSpec(['step' => 's']),
            'response' => new DatamuseResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new DatamuseResult([]),
        ]);
        [, $err] = DatamuseMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new DatamuseSpec(['step' => 's']),
            'response' => new DatamuseResponse(self::resp(200, ['v' => 1])),
            'result' => new DatamuseResult([]),
        ]);
        [, $err] = DatamuseMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new DatamuseSpec(['step' => 's']),
            'response' => new DatamuseResponse(self::resp(200, ['v' => 2])),
            'result' => new DatamuseResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        DatamuseMakeResponse::call($ctx);
    ...
    {
        $preset = new DatamuseResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new DatamuseSpec([]),
            'response' => new DatamuseResponse([]),
            'result' => new DatamuseResult([]),
        ...
        [$got, $err] = DatamuseMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new DatamuseResult([])]);
        [, $err] = DatamuseMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new DatamuseSpec([]), 'result' => null]);
        [, $err] = DatamuseMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new DatamuseSpec(['step' => 's']),
            'result' => new DatamuseResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new DatamuseOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = DatamuseMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new DatamuseSpec(['step' => 's']),
            'result' => new DatamuseResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new DatamuseOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = DatamuseMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new DatamuseResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new DatamuseSpec([]),
            'result' => new DatamuseResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = DatamuseMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = DatamuseMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new DatamuseError('boom', 'boom');
        $utility->fetcher = function (DatamuseContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new DatamuseSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = DatamuseMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (DatamuseContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = DatamuseMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(DatamuseResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (DatamuseContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new DatamuseSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = DatamuseMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new DatamuseResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new DatamuseSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = DatamuseMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = DatamuseMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = DatamuseMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new DatamuseResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, DatamuseDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new DatamuseResult(['ok' => false])]);
        $this->expectException(DatamuseError::class);
        DatamuseDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new DatamuseResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', DatamuseMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        DatamuseMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new DatamuseBaseFeature();
        $b = new DatamuseBaseFeature();
        DatamuseFeatureAdd::call($ctx, $a);
        DatamuseFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): DatamuseBaseFeature
    {
        $f = new DatamuseBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        DatamuseFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): DatamuseContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new DatamuseSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = DatamusePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new DatamuseResponse(['headers' => null]),
            'result' => new DatamuseResult([]),
        ]);
        DatamuseResultHeaders::call($ctx);
