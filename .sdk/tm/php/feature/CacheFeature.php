...
class DatamuseCacheFeature extends DatamuseBaseFeature
{
    ...
    private function _through(DatamuseContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
