...
class DatamuseNetsimFeature extends DatamuseBaseFeature
{
    ...
    private function _simulate(DatamuseContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(DatamuseContext $ctx, array $applied): void
    {
        $client = $this->client;
