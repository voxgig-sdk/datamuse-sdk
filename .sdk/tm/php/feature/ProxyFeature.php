...
class DatamuseProxyFeature extends DatamuseBaseFeature
{
    ...
    public function init(DatamuseContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DatamuseContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
