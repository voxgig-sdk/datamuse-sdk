...
// Datamuse SDK clienttrack feature
...
class DatamuseClienttrackFeature extends DatamuseBaseFeature
{
    ...
    public function PostConstruct(DatamuseContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Datamuse-SDK';
