...
// Datamuse SDK ratelimit feature
...
class DatamuseRatelimitFeature extends DatamuseBaseFeature
{
    ...
    private function _acquire(DatamuseContext $ctx): void
    {
    ...
    private function _track(DatamuseContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
