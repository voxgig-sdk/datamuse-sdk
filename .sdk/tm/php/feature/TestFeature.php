...
// Datamuse SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class DatamuseTestFeature extends DatamuseBaseFeature
{
    ...
    public function init(DatamuseContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (DatamuseContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (DatamuseContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(DatamuseContext $ctx, $op, $args): array
    {
