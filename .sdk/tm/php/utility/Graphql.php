...
class DatamuseGraphql
{
    ...
    // equivalent.
    public static function body(DatamuseContext $ctx): mixed
    {
    ...
    public static function errors(DatamuseContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
