...
// Datamuse SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class DatamuseMakeRequest
{
    public static function call(DatamuseContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new DatamuseResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new DatamuseResponse($fetched);
        } else {
