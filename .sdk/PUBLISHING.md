...
|---|---|---|
| `ts/` | @voxgig-sdk/datamuse-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/datamuse-sdk \
      --repository voxgig-sdk/datamuse-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/datamuse-sdk` shows it, and
`npm trust revoke @voxgig-sdk/datamuse-sdk --id=<id>` removes it.
