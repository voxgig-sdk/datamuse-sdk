...
func NewPetEntity(client *core.DatamuseSDK, entopts map[string]any) *PetEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PetEntity) GetName() string { return e.name }
...
func (e *PetEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PetEntity) Deleted() bool {
	return e.deleted
}


func (e *PetEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPetEntity(e.client, opts)
}

func (e *PetEntity) Data(args ...any) any {
...
func (e *PetEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Pet; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PetEntity) DataTyped(data ...Pet) Pet {
	if len(data) > 0 {
		return typedFrom[Pet](e.Data(asMap(data[0])))
	}
	return typedFrom[Pet](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Pet (all fields
// optional at the wire level).
func (e *PetEntity) MatchTyped(match ...Pet) Pet {
	if len(match) > 0 {
		return typedFrom[Pet](e.Match(asMap(match[0])))
	}
	return typedFrom[Pet](e.Match())
}
...
func (e *PetEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PetEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PetLoadMatch and returns an Pet. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PetEntity) LoadTyped(reqmatch PetLoadMatch, ctrl map[string]any) (Pet, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Pet{}, err
	}
	return typedFrom[Pet](res), nil
}




func (e *PetEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// PetListMatch and returns []Pet. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PetEntity) ListTyped(reqmatch PetListMatch, ctrl map[string]any) ([]Pet, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Pet](res), nil
}




func (e *PetEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// PetCreateData and returns an Pet. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PetEntity) CreateTyped(reqdata PetCreateData, ctrl map[string]any) (Pet, error) {
...
func (e *PetEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *PetEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// PetRemoveMatch and returns an Pet. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *PetEntity) RemoveTyped(reqmatch PetRemoveMatch, ctrl map[string]any) (Pet, error) {
...
func (e *PetEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
