# Datamuse Golang SDK Reference

Complete API reference for the Datamuse Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *DatamuseSDK`
...
#### `Pet(data map[string]any) DatamuseEntity`
