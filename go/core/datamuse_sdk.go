...
func (sdk *DatamuseSDK) OptionsMap() map[string]any {
...
func (sdk *DatamuseSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *DatamuseSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *DatamuseSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DatamuseSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *DatamuseSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *DatamuseSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("DatamuseSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *DatamuseSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DatamuseSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("DatamuseSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
